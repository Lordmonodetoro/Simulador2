...
class PlantaAzucareraCompleta:
    ...
    def mod_1_difusiones(self):
        ...
        out.update({
            ...
            'OUT_DifPren_JugoCrudo_Brix_pct': 17.16,
    ...
    def mod_2_calentamiento_crudo(self, m1):
        ...
        ds_jugo = float(m1['OUT_DifPren_JugoCrudo_Brix_pct'])
        pur_jugo = float(m1['OUT_DifPren_JugoCrudo_Pureza_pct'])
        ...
        out['OUT_CalCrudo_Brix_pct'] = ds_jugo
        out['OUT_CalCrudo_Pureza_pct'] = pur_jugo
        return out
    ...
    def mod_3_depuracion(self, m1, m2, m8):
        ...
        brix_entrada = float(m2['OUT_CalCrudo_Brix_pct'])
        pureza_entrada = float(m2['OUT_CalCrudo_Pureza_pct'])
        ...
        # EL BALANCE CORREGIDO QUE RESTA LOS BARROS 1ro ANTES DE SEGUIR
        ...
        # Re-sumar reciclos al jugo claro
        ...
        brix_fino_real = (ms_fino_final / flujo_jugo_fino_total) * 100.0 if flujo_jugo_fino_total > 0 else 18.40
        pur_fino_real = (pol_fino_final / ms_fino_final) * 100.0 if ms_fino_final > 0 else 91.60
        ...
        out.update({
            ...
            'OUT_1raCarb_Salida_Brix_pct': (ms_jugo_crudo+ms_corefin)/flujo_etapa_3 * 100,
            'OUT_1raCarb_Salida_Pureza_pct': (pol_jugo_crudo+pol_corefin)/(ms_jugo_crudo+ms_corefin) * 100,
            'OUT_2daCarb_Salida_th': flujo_etapa_5,
            'OUT_2daCarb_Salida_Brix_pct': (ms_etapa_5 / flujo_etapa_5) * 100,
            'OUT_2daCarb_Salida_Pureza_pct': (pol_etapa_5 / ms_etapa_5) * 100,
            'OUT_2daFiltracion_LodosRecirc_th': lodos_2do,
            'OUT_JugoFino_Total_th': flujo_jugo_fino_total,
            'OUT_JugoFino_Total_Brix_pct': brix_fino_real,
            'OUT_JugoFino_Total_Pureza_pct': pur_fino_real,
    ...
    def mod_4_calentamiento_jugo_fino(self, m3):
        ...
        brix_fino = float(m3.get('OUT_JugoFino_Total_Brix_pct', 18.40))
        pur_fino = float(m3.get('OUT_JugoFino_Total_Pureza_pct', 91.60))
        ...
        out['OUT_JugoFinoCalentado_Brix_pct'] = brix_fino
        out['OUT_JugoFinoCalentado_Pureza_pct'] = pur_fino
    ...
    def mod_6_casa_cocimiento(self, m1, m7):
        ...
        P_liq = float(m7.get('OUT_StandardLiquor_Pureza_pct', 93.5))
        ...
        out.update({
            ...
            'OUT_AzucarComercial_Silo_Brix_pct': 100.0,
            'OUT_AzucarComercial_Silo_Pureza_pct': P_sugA,
            'OUT_PolvoSecadero_Recuperado_th': (S_A / 0.998) * 0.06,
            'OUT_AzucarB_Fundicion_th': S_B / (P_sugB/100.0),
            'OUT_AzucarB_Fundicion_Brix_pct': 99.0,
            'OUT_AzucarB_Fundicion_Pureza_pct': P_sugB,
            ...
            'OUT_MelazaFinal_Brix_pct': 79.7,
            'OUT_MelazaFinal_Pureza_pct': P_mol
        })
        return out
    ...
    def mod_7_refundicion(self, m5, m3, m6):
        ...
        pur_jarabe_evap = float(m5.get('OUT_ThickJuice_Pureza_pct', 91.60))

        flujo_jugo_fino_th = float(m3.get('OUT_JugoFino_Total_th', 0.0)) * (float(c['OP_JugoFino_DestinoMelting_pct'])/100.0)
        brix_jugo_fino_pct = float(m3.get('OUT_JugoFino_Total_Brix_pct', 18.40))
        pur_jugo_fino_pct = float(m3.get('OUT_JugoFino_Total_Pureza_pct', 91.60))
        ...
        ms_azucar_b = flujo_azucar_b_th * (99.0 / 100.0)
        pol_azucar_b_total = ms_azucar_b * (pol_azucar_b / 100.0)
        ...
        pol_total_th = pol_jarabe + pol_azucar_b_total + pol_polvo + pol_jugo_fino
        ...
        out['OUT_StandardLiquor_Pureza_pct'] = pureza_liquor_estandar
    ...
    def mod_5_evaporacion(self, m4, m3, m6, m7, m1, m2):
        ...
        brix_entrada = float(m4.get('OUT_JugoFinoCalentado_Brix_pct', 18.40))
        pur_entrada = float(m4.get('OUT_JugoFinoCalentado_Pureza_pct', 91.60))
        ...
        out['OUT_ThickJuice_Brix_pct'] = brix_salida_obj
        out['OUT_ThickJuice_Pureza_pct'] = pur_entrada
    ...
    def mod_8_condensados_agua(self, m5, m6, m4, m3, m1, m2, m7):
        ...
        out['INT_Total_Bruto_9620_th'] = total_9620
        out['INT_Flash_Perdido_9620_th'] = flash_9620
    ...
    def mod_9_energia(self, m1, m4, m5, m6):
        ...
        out['INT_MS_Pulpa_Prensada_th'] = ms_pulpa_th
        out['INT_Rendimiento_Termico_Secadero_Factor'] = rend_termico
